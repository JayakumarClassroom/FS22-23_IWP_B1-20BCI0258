...
<div class="outside-container">
	<div class="newsletter-area">
		...
		<p class="subscribe-text">Join over several collegues of VIT - Get coverage delivered to your inbox every morning.</p>
		<form method="post">
		...
		<p><a href="../site/faq.html">Go back to VITravel FAQ page</p>
	</div>
</div>
